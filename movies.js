...
//  (this would be better not in global scope)
let currentId = 0;
...
$(function () {
  ...
  // the closest parent tr and remove from the array of movies
...
/* createMovieDataHTML accepts an object with title 
and rating keys and returns a string of HTML */
